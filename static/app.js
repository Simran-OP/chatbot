        ...
        if (message === "menu") {
            ...
            fetch('/get', {
                ...
                .then(data => {
                    ...
                    //                        console.log("data ans",data.answer)
                    this.messages.push(msg2);
                    this.updateChatText(this.chatBox);
                })
                .catch(error => {
...
sleeping(){
    ...
    //     var html__Image=`<img class="logo_robo"
    //                                src="{{ url_for('static', filename='images/Sleeping.png') }}"
    //                                alt="image">`
    var html__Text = `<h4 class="chatbox__heading--header">Chat support closed</h4>
    ...
    var section=document.querySelector(".chatbox__messages");
...
pinging(){
    ...
    fetch('/get', {
        ...
        .then(data => {
            console.log("data mein aa gya ")
            setTimeout(() => console.log("data"), 1000)
    setTimeout(() => console.log("2"), 1000)
    setTimeout(() => console.log("T3hird"), 1000)
...
awake(){
    //    var html__Image=`<img class="logo_robo"
    //                            src="/images/cute-robot-waving-hand-cartoon-600nw-1917055787.webp"
    //                            alt="image">`

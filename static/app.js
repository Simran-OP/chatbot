...
//                    html += '<div class="messages__item messages__item--visitor">lkdfsfkjfijasdfjdsflkdsjfljdslfjdsfjdslkfjlkdsklsajdflkjdslkfjlkdsajflkdsflkdsflkjdsflkdslkfjdslkfjdslkfjlkdsflkdsjflkdjflkdsjflkdsflkdsjflkdsjflkjdslkfjdslkfjdsljdflkdjflkjslfjdslfdsjjroifrkvndnvoirnvlkdsldsnlfds</div>';
                   html += '<div class="messages__item messages__item--visitor">' + item.msg + '</div>';
//                     html += '<div class="messages__item messages__item--visitor"><div class="typing-indicator"></div></div>'
               }
           } else {
